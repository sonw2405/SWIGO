	...
	<div class="offcanvas-body">
		...
		<div class="offcanvas-form">
			<div class="login-head">
				...
				<p>Chúng tôi rất mong bạn tham gia với SWIGO và đặt hàng từ xa ủng hộ chúng tôi.</p>
				...
				<h6 class="login-title"><span>Hoặc</span></h6>
			</div>
			...
			<div class="quenmk">
				<a class="register text-primary font-weight-500" data-bs-toggle="offcanvas" href="" role="button" aria-controls="offcanvasRegister">Quên mật khẩu</a>
			</div>
			<p class="text-center m-t30">Chưa đăng ký?
				<a class="register text-primary font-weight-500" data-bs-toggle="offcanvas" href="#offcanvasRegister" role="button" aria-controls="offcanvasRegister">Đăng ký ở đây</a>
			</p>
		</div>
	</div>
</div>