...
<!-- Mirrored from swigo.dexignzone.com/xhtml/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Nov 2023 06:15:33 GMT -->

<head>

	<!-- Title -->
	<title>Swigo - Food Business</title>
...
<body id="bg">
	<div id="loading-area2" class="loading-page-1">
		<div class="load-text">
			...
			<span data-text="W" class="text-load">W</span>
				...
				<div class="main-bar clearfix ">
					<div class="container clearfix">
						...
						<div class="logo-header mostion">
							<a href="index-3.html" class="anim-logo"><img src="assets/images/logo.png" alt="/"></a>
						</div>
									...
									<li>
										...
										<ul class="dropdown-menu cart-list">
											...
											<li class="cart-item text-center d-flex justify-content-between">
												<h6 class="text-primary mb-0">Tổng:</h6>
